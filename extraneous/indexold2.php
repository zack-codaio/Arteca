...
if(isset($_SESSION['is_open'])){
    echo '<form class="form-inline pull-right" name="logOut" action="logout.php" method="post"><button  type="submit" class="btn btn-link btn-small"/>Sign Out</button></form>';
  echo '
  <div class="navbar-text pull-right">
  Logged in as <a href="#" class="navbar-link">' . $_SESSION['first'] . ' '. $_SESSION['last'] . '   '. '</a></div>';

  }

//user not logged in
     else{
      echo'<a href="#regModal" role="button" class="btn btn-link pull-right btn-small" data-toggle="modal"> Register</a>';
          echo'  <form class="form-inline pull-right" action="login.php" method ="post">
            ...
            <button type="submit" class="btn btn-link btn-small">Sign In</button>
            </form>';   
          }
echo'       </div>
      </div>
  ...
  <div class="span3">
          <div class="well sidebar-nav">
            <ul class="nav nav-list">
              ...
              <li><a href="#">Favorited Artwork</a></li>
